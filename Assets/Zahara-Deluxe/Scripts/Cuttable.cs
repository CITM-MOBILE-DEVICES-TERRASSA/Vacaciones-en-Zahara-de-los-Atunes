...
public class Cuttable : MonoBehaviour
{
    ...
    public void Cut()
    {
        ...
        GameObject topHalf = Instantiate(topHalfPrefab, new Vector3(transform.position.x+0.1f,transform.position.y,transform.position.z), transform.rotation);
        ...
        if (topRb != null) topRb.AddForce(Vector3.right * 10f, ForceMode.Impulse);
        if (bottomRb != null) bottomRb.AddForce(Vector3.left * 10f, ForceMode.Impulse);
